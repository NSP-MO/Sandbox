...
# Example usage for USDIDR
commodity_data = calculate_futures_price(
    r'C:\Users\Hp\Downloads\comodity-price-prediction-penyisihan-arkavidia-9\Mata Uang\USDIDR=X.csv',  # Updated file path
...
plt.title('Perbandingan Harga Spot dan Futures (USDIDR)')
plt.xlabel('Tanggal')
plt.ylabel('Harga')
plt.legend()
plt.show()