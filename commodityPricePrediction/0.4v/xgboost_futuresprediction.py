...
def process_file(file_path):
    ...
    try:
        ...
        return pd.DataFrame([{
            'id': f"bawang-merah/{province}/{date.strftime('%Y-%m-%d')}",
            'price': round(price, 2)
...
def main():
    # Daftar file CSV
    base_path = r'C:\Users\Hp\Downloads\comodity-price-prediction-penyisihan-arkavidia-9\Google Trend\bawang'
    provinces = [
        'Aceh', 'Bali', 'Banten', 'Bengkulu', 'DI Yogyakarta', 'DKI Jakarta',
        'Gorontalo', 'Indonesia', 'Jambi', 'Jawa Barat', 'Jawa Tengah',
